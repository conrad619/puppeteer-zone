...
const country = 'Zone 3';
const username = 'conrad@rakwireless.com';
const password = 'conradrakwireless';
const profile = 'https://rak-dev030122.myshopify.com/admin/settings/shipping/profiles/87769153750';
...
(async () => {
    ...
    const wsChromeEndpointurl = "ws://127.0.0.1:9222/devtools/browser/45ea6c24-9410-4730-a718-594ffdd4a957";
    ...
    for(let i=0;i<=price.length;i++){
        await page.evaluate(async (country)=>{
            ...
            console.log("card")
            let tab= await document.querySelectorAll('.Polaris-Card__Section_1b1h1')
            let t = [...tab]
            let tb = t.find(tt=>{
